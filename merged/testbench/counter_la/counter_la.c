...
*/	initfir();
	...
	int* y_fir = fir();
	// end mark
	reg_mprj_datal = (*y_fir << 24) | (0x5A << 16); //mprj[31:0] = {fianl Y, EndMark, 16'h0000} 
	...
	int* y_mm = matmul();
	// end mark
	// reg_mprj_datal = *(y+3) << 16;
	// reg_mprj_datal = *(y+7) << 16;
	// reg_mprj_datal = *(y+11) << 16;
	reg_mprj_datal = *(y_mm+15) << 16;	
