...
.Ltext0:
	...
	.file 0 "/home/ubuntu/SoC_Lab_Final_UART/testbench/uart" "../../firmware/isr.c"
	.align	2
...
.LFB321:
	...
	j	.L11
.L12:
	.loc 5 41 19 discriminator 3
	call	uart_read
	sw	a0,-32(s0)
	.loc 5 42 13 discriminator 3
	lw	a0,-32(s0)
	call	uart_write
	.loc 5 39 43 discriminator 3
	lw	a5,-20(s0)
	addi	a5,a5,1
	sw	a5,-20(s0)
.L11:
	.loc 5 39 23 discriminator 1
	lw	a4,-20(s0)
	lw	a5,-28(s0)
	blt	a4,a5,.L12
	.loc 5 51 5
...
.LASF1:
	.string	"/home/ubuntu/SoC_Lab_Final_UART/testbench/uart"
.LASF0:
